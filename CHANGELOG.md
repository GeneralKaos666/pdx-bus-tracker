...
- **Arrivals holds up better:** a scheduled time no longer looks like a live one, a stop with only an arrival or two no longer leaves a big empty space, and the stop number is easier to read.
