...
- **Nearby stops now tell you how far and which way:** each row in the nearby list shows the walking distance and the compass direction to the stop, nearest first. Distances come from TriMet; the direction is worked out from where you are. Lists that do not know your location are unchanged.
