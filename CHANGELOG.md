...
- **Fixed:** the Trip Planner now tells real TriMet outages apart from connectivity hiccups — when your network drops or a request times out it says "Can't reach TriMet right now" and retries once, reserving "temporarily unavailable" for genuine server trouble.
