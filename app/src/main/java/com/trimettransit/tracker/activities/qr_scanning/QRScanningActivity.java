...
import com.trimettransit.tracker.camera.CameraSource;
import com.trimettransit.tracker.camera.CameraSourcePreview;
import com.trimettransit.tracker.camera.GraphicOverlay;
import com.trimettransit.tracker.util.RequestCodeGenerator;
...
public class QRScanningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        cameraGraphicOverlay = findViewById(R.id.activity_qr_scanning_graphic_overlay);
        cameraSourcePreview = findViewById(R.id.activity_qr_scanning_preview);
        toolbar = findViewById(R.id.activity_qr_scanning_toolbar);
